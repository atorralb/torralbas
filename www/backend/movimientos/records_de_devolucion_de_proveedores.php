...
<HTML>
<head>
<a href = "records_de_devolucion_de_proveedores.php?accion=fin" >finalizar sesion</a>
<?php	
...
<BODY>
<form action=records_de_devolucion_de_proveedores.php method=get>
<table>
...
while( $row=mysqli_fetch_array($result)){
	...
	<td>$".$costodecompra."</td>
	<td>$".$pv."</td>
	<td><a href=records_de_devolucion_de_proveedores.php?accion=eliminar&id=".$id.">eliminar</a></td></tr>";
	echo "\n";
	}			
?>
</TABLE>
