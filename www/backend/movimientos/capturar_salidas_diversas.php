...
<HTML>
<head>
<a href = "capturar_entradas_diversas.php?action=fin" >finalizar sesion</a>
<?php
...
<BODY>
<form action=capturar_salidas_diversas.php method=get>
<table>
...
if($cprov != "" && $cprod != "" && $cantidad != ""){
	...
	$result=mysqli_query($mysqli,"SELECT  
		...
		<td>$".$costodecompra."</td>
		<td>$".$pv."</td>
		<td><a href=capturar_salidas_diversas.php?accion=eliminar&id=".$id.">eliminar</a></td></tr>";
		echo "\n";
		}			
?>
</TABLE>
