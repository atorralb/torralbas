...
if($action=="del"){mysqli_query($mysqli,"DELETE FROM red WHERE id=$id;");}
...
if($cprov != "" && $cprod != "" && $cantidad != "") { mysqli_query($mysqli,"INSERT INTO red (f, cprov, cprod, cantidad) VALUES ('$folio', '".$existeproducto['cprov']."', '".$existeproducto['cprod']."', '$cantidad' );");}
...
mysqli_query($mysqli,"delete from red where f = $folio and cprov ='' and cprod =0;");
