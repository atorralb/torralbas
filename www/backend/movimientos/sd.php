...
<?
	...
	mysqli_query($mysqli,"INSERT INTO sd (fecha, movimiento, almacen1, almacen2, concepto, ne, nr, na, factura) VALUES ('$fecha1', '6', '0', '$almacen2', '$concepto', '$ne', '$nr', '$na', '0');");


	$rmf = mysqli_query($mysqli,"select max(folio) as maxfolio from sd;"); 
	...
	$folio = $maxfolio;	
	$result = mysqli_query($mysqli,"SELECT * FROM sd WHERE folio = '$folio';");
