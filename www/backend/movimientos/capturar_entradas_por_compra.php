...
<HTML>
<head>
<a href = "capturar_entradas_por_compra.php?accion=fin" >finalizar sesion</a>
<?php	
$accion = urlencode(@$_REQUEST['accion']);
if($accion == "fin"){
	session_destroy();
	echo "<br><b>SESION FINALIZADA</b> <br><a href ='../../INVENTARIO/movimientos/formulario.php'>empezar nuevo folio de devolucion de proveedores</a>";
	}
?>	
</head>
<STYLE>
...
<BODY>
<form accion=capturar_entradas_por_compra.php method=get>
<table>
...
while( $row=mysqli_fetch_array($result)){
	...
	<td>$".$costodecompra."</td>
	<td>$".$pv."</td>
	<td><a href=capturar_entradas_por_compra.php?accion=eliminar&id=".$id.">eliminar</a></td></tr>";
	echo "\n";
	}			
?>
</TABLE>
